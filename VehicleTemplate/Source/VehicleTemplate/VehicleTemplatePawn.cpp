...
void AVehicleTemplatePawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	//Added the Respawn input
	PlayerInputComponent->BindAction("Respawn", IE_Pressed, this, &AVehicleTemplatePawn::Respawn);
...
void AVehicleTemplatePawn::Respawn()
{
	this->TeleportTo(SpawnLocation, SpawnRotation);
}

void AVehicleTemplatePawn::SetSpawn(FVector Position, FRotator Rotation)
{
	this->SpawnLocation = Position;
	this->SpawnRotation = Rotation;
}

int AVehicleTemplatePawn::NumOfCheckPoints()
{
	return CheckPoints.Num();
}

void AVehicleTemplatePawn::SetNextCheckPoint()
{
...
int AVehicleTemplatePawn::GetNextCheckPointNum()
{
	return this->NextCheckPoint;
}

void AVehicleTemplatePawn::CompleteLap()
{
	NextCheckPoint = 1;
	LapsRemaing--;
}

int AVehicleTemplatePawn::GetLapsRemaining()
{
	return this->LapsRemaing;
}

void AVehicleTemplatePawn::OnHit(AActor* SelfActor, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
